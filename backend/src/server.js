...
app.use(helmet({
  ...
  contentSecurityPolicy: {
    directives: {
      ...
      imgSrc: ["'self'", 'data:', 'https:', 'http:', 'http://localhost:5000', 'http://10.244.0.147:5000', 'blob:'],
      scriptSrc: ["'self'", "'unsafe-inline'", "'unsafe-eval'"],
      connectSrc: ["'self'", 'http://localhost:3000', 'http://localhost:5000', 'http://10.244.0.147:3000', 'http://10.244.0.147:5000'],
      formAction: ["'self'", 'http://localhost:5000', 'http://10.244.0.147:5000'],
      frameSrc: ["'self'"],
      objectSrc: ["'none'"],
